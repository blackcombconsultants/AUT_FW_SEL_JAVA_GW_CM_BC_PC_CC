...
public class PA_Rewrite_FullTerm extends GW_GetDriver {
	...
	public void AUT_PA_PC_Rewrite_FullTerm_01() throws Throwable {
		...
		Tab_Menu_Navigation.pcMenuNavigation("Rewrite Full Term");
		...
		PolicyCenter_Resuables.clickButton("Issue Policy for Rewrite Full Term");
		...
		PC_Bound.RewriteFullTermBound_ViewYourPolicy();
