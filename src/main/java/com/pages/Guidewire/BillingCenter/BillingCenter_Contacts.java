...
public class BillingCenter_Contacts extends SeleniumWebDriver_Commands implements BillingCenter_Contacts_PO{
	...
	public static void  C_ContactInfo_Verify() throws Throwable
	{
		lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("Contacts",
				strTestCaseName);
		GuidewireAutomate_Validation("Screen Header", Contacts_Header, "equals",
				"Contacts");
		
		GuidewireAutomate_Validation("CI Type", Contacts_CI_Type, "equals",
				lhm_TestCase_Table_Data.get("TD_Type"));
		GuidewireAutomate_Validation("CI Name", Contacts_CI_Name, "equals",
				lhm_TestCase_Table_Data.get("TD_Name"));
		GuidewireAutomate_Validation("CI_Email", Contacts_CI_Email, "equals",
