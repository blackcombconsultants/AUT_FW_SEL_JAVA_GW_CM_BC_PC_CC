...
public interface BillingCenter_Resuables_PO {
	...
	final By InfoBar_ReinstatementNumber = By
			.xpath("//div[@id='gw-west-center']//div[@class='gw-Wizard--Title' and contains(text(),'Reinstatement ')]");
	final By InfoBar_RewriteNumber = By
			.xpath("//div[@id='gw-west-center']//div[@class='gw-Wizard--Title' and contains(text(),'Rewrite ')]");
	final By InfoBar_Job = By.xpath("//div[contains(@id,'InfoBar-JobLabel')]//div[@class='gw-label']");
	final By InfoBar_ReinstatementJob = By
			.xpath("//div[contains(@id,'InfoBar-ReinstatementLabel')]//div[@class='gw-label']");
	...
	final By NewAccount_Header = By.xpath(
			"//div[@id='NewAccount-NewAccountScreen-ttlBar']//div[ @class='gw-TitleBar--title' and text()='New Account']");
	final By SearchforAccounts_Header = By.xpath(
			"//div[@id='AccountSearchPopup-AccountSearchScreen-ttlBar']//div[ @class='gw-TitleBar--title' and text()='Search for Accounts']");
	final By PolicyIssuanceWizardStep1_Header = By.xpath(
			"//div[@id='NewPolicyWizard-NewPolicyWizardSummaryStepScreen-ttlBar']//div[ @class='gw-TitleBar--title']");
	final By PolicyIssuanceWizardStep2_Header = By.xpath(
			"//div[@id='NewPolicyWizard-NewPolicyWizardChargeStepScreen-ttlBar']//div[ @class='gw-TitleBar--title']");
	final By AccountSummary_Header = By
			.xpath("//div[@id='AccountSummary-AccountSummaryScreen-ttlBar']//div[ @class='gw-TitleBar--title']");
	...
	final By ParentAccount_SearchButton = By
			.xpath("//div[contains(@id,'ParentAccount-AccountPicker')]//span[contains(@class,'gw-font-icon')]");
	...
	final By AS_AccountName = By
			.xpath("//div[@id='AccountSummary-AccountSummaryScreen-Name']//div[@class='gw-ActionValueWidget']");
	final By AS_PrimaryContact = By.xpath(
			"//div[@id='AccountSummary-AccountSummaryScreen-PrimaryContact']//div[@class='gw-ActionValueWidget']");
	final By AS_Currency = By
			.xpath("//div[@id='AccountSummary-AccountSummaryScreen-Currency']//div[@class='gw-label']");
	final By AS_PayoffAmount = By.xpath(
			"//div[@id='AccountSummary-AccountSummaryScreen-PayoffAmount']//div[@class='gw-value-readonly-wrapper']");
	 ...
	 *
	 */
	final By FundsTracking_Header = By.xpath(
			"//div[@id='AccountDetailFundsTracking-AccountDetailFundsTrackingScreen-ttlBar']//div[ @class='gw-TitleBar--title' and text()='Funds Tracking']");
	...
	final By Payments_Header = By.xpath(
			"//div[@id='AccountPayments-AccountDetailPaymentsScreen-ttlBar']//div[ @class='gw-TitleBar--title' and text()='Payments']");
	final By Payments_PaymentDetails_Tab = By
			.xpath("//div[contains(@id,'AccountPaymentDistributionItemsCV-PaymentDetailsTab')]//div[@role='tab']");
	final By Payments_SuspenseItems_Tab = By
			.xpath("//div[contains(@id,'AccountPaymentDistributionItemsCV-suspenseItemsCardTab')]//div[@role='tab']");
	final By Payments_PreviousVersions_Tab = By
			.xpath("//div[contains(@id,'AccountPaymentDistributionItemsCV-reversedMoniesTab')]//div[@role='tab']");
	 ...
	 * Direct Bill Payment
	 */
	final By DBP_Header = By
			.xpath("//div[@id='NewDirectBillPayment-EditDBPaymentScreen-ttlBar']//div[ @class='gw-TitleBar--title']");
	final By DBP_Amount = By
			.xpath("//input[contains(@name,'NewDirectBillPayment-EditDBPaymentScreen-PaymentDetailsDV-Amount')]");
	final By DBP_PaymentInstrument = By.xpath("//select[contains(@name,'PaymentInstrument')]");
	final By DBP_Description = By.xpath("//input[contains(@name,'PaymentDetailsDV-Description')]");
	final By DBP_ExecuteWithoutDistribution = By.xpath(
			"//div[contains(@id,'ExecuteWithoutDistribution')]//div[@role='button']/div[text()='Execute Without Distribution']");
