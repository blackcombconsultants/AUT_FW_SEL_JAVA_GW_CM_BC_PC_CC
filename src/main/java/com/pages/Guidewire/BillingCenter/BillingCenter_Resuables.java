...
public class BillingCenter_Resuables extends SeleniumWebDriver_Commands implements BillingCenter_Resuables_PO {
    ...
    public static void launch_BillingCenter() throws Throwable {
        ...
        /*GW_GetDriver objdriver= new GW_GetDriver();
        objdriver.getDriver();*/
    ...
    public static void login_BillingCenter_User(String strUser) throws Throwable {
        ...
        try {
            ...
            lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("login", strUser);
    ...
    public static void bcTabNavigation_Acct_Search() throws Throwable {
        lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_BillingCenter("searchValues");
    ...
    public void bc_NewAccount() throws Throwable {
        ...
        lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_BillingCenter("Account");
    ...
    public static void DirectBillPayment() throws Throwable {
        lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_BillingCenter("DirectBillPayment");
