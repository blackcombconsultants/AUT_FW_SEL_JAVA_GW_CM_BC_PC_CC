...
public class GL_Modifiers extends SeleniumWebDriver_Commands {
	...
	private static By GLScheduleModifier = By.xpath("//div[contains(@id,'ratingInputName_Input')]//div[@class='gw-value-readonly-wrapper' and text()='GL Schedule Modifier'] ");

	// Location Inside Premises
	private static By RI_LocationInsidePremises = By.xpath("//div[contains(@id,'Category')]//div[@class='gw-value-readonly-wrapper' and text()='Location - Inside Premises']");
	private static By RI_LIP_Minimum            = By.xpath("//div[contains(text(),'Location - Inside Premises')]//ancestor::td//following-sibling::td[contains(@id,'Minimum_Cell')]//div[@class='gw-value-readonly-wrapper']");
	private static By RI_LIP_Maximum            = By.xpath("//div[contains(text(),'Location - Inside Premises')]//ancestor::td//following-sibling::td[contains(@id,'Maximum_Cell')]//div[@class='gw-value-readonly-wrapper']");
	private static By RI_LIP_CreditDebit        = By.xpath("//div[contains(text(),'Location - Inside Premises')]//ancestor::td//following-sibling::td[contains(@id,'CreditDebit_Cell')]//input[contains(@name,'CreditDebit')]");
	private static By RI_LIP_Justification      = By.xpath("//div[contains(text(),'Location - Inside Premises')]//ancestor::td//following-sibling::td[contains(@id,'Justification_Cell')]//input[contains(@name,'Justification')]");

	public static void RatingInputs() throws Throwable {
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcelWorkSheet_Fillo("Modifiers", strTestCaseName);
