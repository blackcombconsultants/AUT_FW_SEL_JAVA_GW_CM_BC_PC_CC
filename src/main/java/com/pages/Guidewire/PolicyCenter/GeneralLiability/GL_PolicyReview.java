...
public class GL_PolicyReview extends SeleniumWebDriver_Commands {
	...
	public static void PrimaryNamedInsured() throws Throwable {
		...
		try {
			...
			GuidewireAutomate_Validation("Primary Named Insured", PR_PrimaryNamedInsured, "equals", lhm_TestCase_Table_Data.get("PR_PrimaryNamedInsured"));
	...
	public static void PolicyDetails() throws Throwable {
		try {
			...
			/*
			 * GuidewireAutomate_Validation("LocationName", PD_LocationName, "equals", lhm_TestCase_Table_Data.get("PD_LocationName"));
			 */
			GuidewireAutomate_Validation("ClassCode", PD_ClassCode, "equals", lhm_TestCase_Table_Data.get("PD_ClassCode"));
			GuidewireAutomate_Validation("Description", PD_Description, "equals", lhm_TestCase_Table_Data.get("PD_Description"));
		} catch (Exception e) {
