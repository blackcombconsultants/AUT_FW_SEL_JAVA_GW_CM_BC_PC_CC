...
public class PC_NewDocument extends SeleniumWebDriver_Commands {

	public PC_NewDocument(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void addCreateTemplate() throws Throwable {
		...
		lhm_TestCase_Table_Data = PolicyCenter_Resuables.getData_PolicyCenter("Documents");
