...
public class PA_PolicyInfo extends SeleniumWebDriver_Commands {
	Selenium_Utils_DataBase oDB = new Selenium_Utils_DataBase();

	public PA_PolicyInfo(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void dateQuoteNeeded() throws Throwable {
		lhm_TestCase_Table_Data = PA_Reusable.getData_PersonalAuto("policyInfo");
