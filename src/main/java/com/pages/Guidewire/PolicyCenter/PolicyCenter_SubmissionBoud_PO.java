...
public interface PolicyCenter_SubmissionBoud_PO {
	...
	final By Submit_an_application_for_a_different_account = By.xpath(
			"//div[contains(@id,'JobCompleteDV-SubmitAnother')]//div[text()='Submit an application for a different account']");
	
	final By Go_To_Your_Desktop = By.xpath("//div[contains(@id,'JobCompleteDV-ReturnToDesktop')]//div[text()='Go to your desktop']");
