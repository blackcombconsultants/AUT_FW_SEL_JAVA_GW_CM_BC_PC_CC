...
public class WC_RiskAnalysis extends SeleniumWebDriver_Commands {

	public WC_RiskAnalysis(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void addUWIssue() throws Throwable {
		...
		GuidewireAutomate("Add UW Issue", RA_AddUWIssue_Button, "clickAndwait", "click");
		...
		GuidewireAutomate("Create an UW Issue", RA_OK_Button, "clickAndwait", "click");
	...
	public static void approveUWIssues() throws Throwable {
		...
		GuidewireAutomate("UWIssues Tab", RA_Tab_UWIssues, "clickAndwait", "click");
	...
	public static void addUWContingency() throws Throwable {
		...
		GuidewireAutomate_Validation("Risk Analysis", PolicyCenter_Resuables_PO.RiskAnalysis_Header, "equals", "Risk Analysis");
		GuidewireAutomate("Add Contingency", RA_AddContingency_Button, "clickAndwait", "click");
		...
		GuidewireAutomate("OK", RA_OK_Button, "clickAndwait", "click");
		 ...
		 * Contingencies Tab
		 */
		GuidewireAutomate("UWIssues Tab", RA_Tab_Contingencies, "clickAndwait", "click");
	...
	public static void RA_LockForReview() throws Throwable {
		...
		GuidewireAutomate("Release Lock", RA_RequestApproval_Button, "clickAndwait", "click");
	...
	public static void addUWIssue_MandatoryValidation() throws Throwable {
		...
		GuidewireAutomate("Error message focus", RA_Error_focus, "clickAndwait", "click");
	...
	public static void priorPolicies_Add() throws Throwable {
		...
		GuidewireAutomate("Prior Policies Tab", RA_Tab_PriorPolicies, "clickAndwait", "click");

		GuidewireAutomate_Validation("Prior Policies", RA_PP_PriorPolicies, "equals", "Prior Policies");

		GuidewireAutomate("Add", RA_PP_Add_Button, "clickAndwait", "click");
	...
	public static void priorPolicies_Edit() throws Throwable {
		...
		GuidewireAutomate("Select", RA_PP_Select, "clickAndwait", "click");
	...
	public static void priorPolicies_Remove() throws Throwable {
		...
		GuidewireAutomate("Select", RA_PP_Select, "clickAndwait", "click");
		GuidewireAutomate("Add", RA_PP_Remove_Button, "clickAndwait", "click");
	...
	public static void priorLosses_Add() throws Throwable {
		...
		GuidewireAutomate("Add", RA_PL_Add_Button, "clickAndwait", "click");
	...
	public static void releaseLock() throws Throwable {
		...
		GuidewireAutomate("Release", RA_UWA_Release, "clickAndwait", "click");
	...
	public static void issuesthatblockIssuance() throws Throwable {
		...
		GuidewireAutomate("Details", IBA_Details_Button, "clickAndwait", "click");
