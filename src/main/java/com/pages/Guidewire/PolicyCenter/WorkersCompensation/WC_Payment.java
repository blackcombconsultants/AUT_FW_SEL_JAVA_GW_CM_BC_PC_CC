...
public class WC_Payment extends SeleniumWebDriver_Commands {

	public WC_Payment(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void billing() throws Throwable {
		...
		GuidewireAutomate("BillingLevel", PA_B_BillingLevel, "clickAndwait", "click");
	...
	public static void billing_AlternateBillingAccount_Search() throws Throwable {
		...
		GuidewireAutomate("Alternate Billing Account Search", PA_B_ABA_Search, "clickAndwait", "click");
		...
		GuidewireAutomate("Search", pa_Alternate_Billing_Account_Search_Button, "clickAndwait", "click");
		GuidewireAutomate("Select", pa_Alternate_Billing_Account_Search_Select, "clickAndwait", "click");
	...
	public static void billing_AlternateBillingAccount_BillingSubaccounts() throws Throwable {
		...
		GuidewireAutomate("Alternate Billing Account Search", PA_B_BillingContact, "clickAndwait", "click");
		GuidewireAutomate("Sending AccountNumber", PA_B_ABA_AccountNumber, "sendKeys", lhm_TestCase_Table_Data.get("PA_B_ABA_AccountNumber"));
		GuidewireAutomate("Search", pa_Alternate_Billing_Account_Search_Button, "clickAndwait", "click");
		GuidewireAutomate("Select", pa_Alternate_Billing_Account_Search_Select, "clickAndwait", "click");
	...
	public static void billingContact(String Account) throws Throwable {
		...
		GuidewireAutomate("Billing Contact icon", PA_B_BillingContact, "clickAndwait", "click");
		switch (Account) {
			case "New Company" :
				GuidewireAutomate("New Company", PA_B_BC_NewCompany, "clickAndwait", "click");
				break;
			case "New Person" :
				GuidewireAutomate("New Person", PA_B_BC_NewPerson, "clickAndwait", "click");
				break;

			case "From Address Book" :
				GuidewireAutomate("From Address Book", PA_B_BC_FromAddressBook, "clickAndwait", "click");
				break;

			case "Existing Billing Contacts" :
				GuidewireAutomate("Existing Billing Contacts", PA_B_BC_ExistingBillingContacts, "clickAndwait", "click");
				break;

			case "Other Contacts" :
				GuidewireAutomate("Other Contacts", PA_B_BC_OtherContacts, "moveToElement", "click");
				break;
