...
public class WC_Forms extends SeleniumWebDriver_Commands {
	Selenium_Utils_DataBase oDB = new Selenium_Utils_DataBase();

	public WC_Forms(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void pa_forms() throws Throwable {
		// lhm_TestCase_Table_Data = WC_Reusables.getData_PersonalAuto("forms");
