...
public class CPACK_CP_LineReview extends SeleniumWebDriver_Commands {

	public CPACK_CP_LineReview(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void LR_PrimaryInsured_CP() throws Throwable {

		try {

			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcelWorkSheet_Fillo("lineReview_CP", strTestCaseName);
