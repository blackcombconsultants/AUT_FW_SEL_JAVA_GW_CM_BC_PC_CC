...
public class CPACK_CP_Modifiers extends SeleniumWebDriver_Commands {

	public CPACK_CP_Modifiers(WebDriver driver, ExtentTest oExtentTest) {
	...
	private static By ScheduleRates = By.xpath("//div[contains(@id,'ratingInputName_Input')]//div[@class='gw-value-readonly-wrapper' and text()='Schedule Rates']");
	...
	public static void RatingInputs() throws Throwable {
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcelWorkSheet_Fillo("Modifiers2", strTestCaseName);
