...
public class CPACK_LineReview extends SeleniumWebDriver_Commands {

	public CPACK_LineReview(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void LR_PrimaryInsured_GL() throws Throwable {

		try {

			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcelWorkSheet_Fillo("lineReview_GL", strTestCaseName);
