...
public class CPACK_IM_BuildingsAndLocations extends SeleniumWebDriver_Commands {

	public CPACK_IM_BuildingsAndLocations(WebDriver driver, ExtentTest oExtentTest) {
