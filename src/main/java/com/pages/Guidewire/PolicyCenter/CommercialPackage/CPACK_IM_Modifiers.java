...
public class CPACK_IM_Modifiers extends SeleniumWebDriver_Commands {

	public CPACK_IM_Modifiers(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void RatingInputs() throws Throwable {
		try {
			...
			GuidewireAutomate_Validation("Package IRPM", PackageIRPM, "equals", "Package IRPM");
