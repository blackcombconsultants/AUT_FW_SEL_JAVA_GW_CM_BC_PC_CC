...
public class BO_Forms extends SeleniumWebDriver_Commands {

	public BO_Forms(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void pa_forms() throws Throwable {
		lhm_TestCase_Table_Data = BO_Resuables.getData_BusinessOwners("forms");
