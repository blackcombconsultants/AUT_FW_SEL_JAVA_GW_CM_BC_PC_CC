...
public class BO_Quote extends SeleniumWebDriver_Commands {

	public BO_Quote(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void quoteDetails() throws Throwable {
		try {
			...
			lhm_TestCase_Table_Data = BO_Resuables.getData_BusinessOwners("Quote");
