...
public class BO_Payment extends SeleniumWebDriver_Commands {

	public BO_Payment(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void premiumSummary() throws Throwable {
		lhm_TestCase_Table_Data = BO_Resuables.getData_BusinessOwners("payment");
