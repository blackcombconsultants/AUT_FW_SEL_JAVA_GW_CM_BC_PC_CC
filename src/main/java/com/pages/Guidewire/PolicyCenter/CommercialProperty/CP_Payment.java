...
public class CP_Payment extends SeleniumWebDriver_Commands {

	public CP_Payment(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void premiumSummary() throws Throwable {
		try {
			...
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcelWorkSheet_Fillo("payment", strTestCaseName);
	...
	public static void billing() throws Throwable {
		try {
			...
			GuidewireAutomate("BillingLevel", PA_B_BillingLevel, "click", "click");
	...
	public static void paymentSchedule() throws Throwable {
		try {
			...
			By     PA_PS_Installment = By.xpath(
					"//div[text()='" + strDynamicXpath + "']/ancestor::td[contains(@class,'gw-CellWidget')]/following-sibling::td[contains(@id,'-Installment') and contains(@class,'gw-FormatCellWidget')]//div[contains(@id,'InstallmentPreview')]");
			By     PA_PS_Total       = By
