...
public class CP_Blankets extends SeleniumWebDriver_Commands {
	...
	public static void Blankets() throws Throwable {
		...
		try {
			...
			GuidewireAutomate("Add Blanket Button", AddBlanketButton, "clickAndwait", "click");
			Thread.sleep(2000);
	...
	public static void BlanketDetails() throws Throwable {
		...
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcelWorkSheet_Fillo("Blankets", strTestCaseName);
			...
			GuidewireAutomate("Show Coverages Button", ShowCoveragesButton, "clickAndwait", "click");
			GuidewireAutomate("Location Check Box", LocationCheckBox, "clickAndwait", "click");
			GuidewireAutomate("Include Selected In Blanket Button", IncludeSelectedInBlanketButton, "clickAndwait", "click");
