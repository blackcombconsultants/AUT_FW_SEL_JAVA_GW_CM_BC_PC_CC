...
public class HO_Modifiers extends SeleniumWebDriver_Commands {
	...
	private static By HO_Mod_MultiPolicy           = By.xpath("  //div[@class='gw-label' and text()='Multi Policy']/parent::div //input[@type='radio' and @value='false']");
	private static By HO_Mod_Professional          = By.xpath("//div[@class='gw-label' and text()='Professional']/parent::div//select[contains(@name,'TypeKeyModifier')]");
	private static By HO_Mod_Loyalty               = By.xpath("//div[@class='gw-label' and text()='Loyalty']/parent::div//select[contains(@name,'TypeKeyModifier')]");
	/***
	 * DWELLING
	 */
	private static By HO_Mod_Dwelling              = By.xpath("//div[@role='heading' and text()='Dwelling']");
	private static By HO_Mod_MannedSecurity        = By.xpath("//div[@class='gw-label' and text()='Manned Security']/parent::div //input[@type='radio' and @value='false']");

	private static By HO_Mod_InternetOfThings = By.xpath(" //div[@class='gw-label' and text()='Internet Of Things']/parent::div //input[@type='radio' and @value='false']");
