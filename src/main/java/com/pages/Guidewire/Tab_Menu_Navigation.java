	...
	public static void pcMenuNavigation(String Menu) throws Throwable {
		switch (Menu) {
			...
			case "Move Policies to this Account" :
				GuidewireAutomate("Actions", Menu_Actions, "click", "click");
				GuidewireAutomate("Move_Policies_to_this_Account", MenuPC_Account_Actions_MovePoliciesToThisAccount, "click", "click");
				break;
			case "Rewrite Policires to this Account" :
				GuidewireAutomate("Actions", Menu_Actions, "click", "click");
				GuidewireAutomate("Rewrite_Policires_to_this_Account", MenuPC_Account_Actions_RewritePoliciesToThisAccount, "click", "click");
				break;
			case "Merge Account into this Account" :
				GuidewireAutomate("Actions", Menu_Actions, "click", "click");
				GuidewireAutomate("Merge_Account_into_this_Account", MenuPC_Account_Actions_MergeAccountIntoThisAccount, "click", "click");
				break;
			...
			case "Rewrite Remainder of Term" :
				GuidewireAutomate("Actions", Menu_Actions, "click", "click");
				GuidewireAutomate("Rewrite Remainder of Term", MenuPC_Actions_Policy_NewPolicyTransaction_RewriteRemainderOfTerm, "click", "click");
				break;
	...
	public static void bcMenuNavigation(String Menu) throws Throwable {
		switch (Menu) {
			...
			case "Commission Recovery Write-Off" :
				GuidewireAutomate("Actions", Menu_Actions, "click", "click");
				GuidewireAutomate("Commission Recovery Write-Off", MenuBC_Producer_Actions_CommissionRecoveryWriteOff, "click", "click");
				break;
			...
			case "New Payment Allocation Plan" :
				GuidewireAutomate("Actions", Menu_Actions, "click", "click");
				GuidewireAutomate("NewPaymentAllocationPlan", MenuBC_Administration_Actions_NewPaymentAllocationPlan, "click", "click");
				break;
			...
			case "New Authority Limit Profile" :
				GuidewireAutomate("Actions", Menu_Actions, "click", "click");
				GuidewireAutomate("NewAuthorityLimitProfile", MenuBC_Administration_Actions_NewAuthorityLimitProfile, "click", "click");
				break;
			/*
			 * Menu Links
			 */
			...
			case "Activity Patterns" :
				GuidewireAutomate("NewAuthorityLimitProfile", MenuBC_Administration_BusinessSettings_ActivityPatterns, "click", "click");
				break;
			case "Monitoring" :
	...
	public static void ccMenuNavigation(String Menu) throws Throwable {
		...
		switch (Menu) {
			...
			case "Indicate existence of a document" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Indicate existence of a document", MenuCC_Claim_Actions_NewDocument_Indicateexistenceofadocument, "click", "click");
				break;
			...
			case "Send claim acknowledgement letter" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Correspondence", MenuCC_Claim_Actions_NewActivity_Correspondence, "moveToElement", "moveToElement");
				GuidewireAutomate("Send claim acknowledgement letter", MenuCC_Claim_Actions_NewActivity_Correspondence_SendclaimAcknowledgementLetter, "click", "click");
				break;
			...
			case "Send reservation of rights letter" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Correspondence", MenuCC_Claim_Actions_NewActivity_Correspondence, "moveToElement", "moveToElement");
				GuidewireAutomate("Send reservation of rights letter", MenuCC_Claim_Actions_NewActivity_Interview_GetAStatementFromWitness, "click", "click");
				break;
			case "Interview" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
			...
			case "Get a statement from witness" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Interview", MenuCC_Claim_Actions_NewActivity_Interview, "moveToElement", "moveToElement");
				GuidewireAutomate("Get a statement from witness", MenuCC_Claim_Actions_NewActivity_Interview_GetAStatementFromWitness, "click", "click");
				break;
			case "Make initial contact with insured" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Interview", MenuCC_Claim_Actions_NewActivity_Interview, "moveToElement", "moveToElement");
				GuidewireAutomate("Make initial contact with insured", MenuCC_Claim_Actions_NewActivity_Interview_MakeInitialContactWithInsured, "click", "click");
				break;
			case "New Mail" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
			...
			case "Review new bill received" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("New Mail", MenuCC_Claim_Actions_NewActivity_NewMail, "moveToElement", "moveToElement");
				GuidewireAutomate("Review new bill received", MenuCC_Claim_Actions_NewActivity_NewMail_ReviewNewBillReceived, "click", "click");
				break;
			...
			case "Additional living expenses required" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Request", MenuCC_Claim_Actions_NewActivity_Request, "moveToElement", "moveToElement");
				GuidewireAutomate("Additional living expenses required", MenuCC_Claim_Actions_NewActivity_Request_AdditionalLivingExpensesRequired, "click", "click");
				break;
			case "Create Recovery email bill1" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Request", MenuCC_Claim_Actions_NewActivity_Request, "moveToElement", "moveToElement");
				GuidewireAutomate("Create Recovery email bill1", MenuCC_Claim_Actions_NewActivity_Request_CreateRecoveryEmailBill1, "click", "click");
				break;
			case "Create Recovery email bill2" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Request", MenuCC_Claim_Actions_NewActivity_Request, "moveToElement", "moveToElement");
				GuidewireAutomate("Create Recovery email bill2", MenuCC_Claim_Actions_NewActivity_Request_CreateRecoveryEmailBill2, "click", "click");
				break;
			...
			case "Unable to close the claim or the exposure" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Warning", MenuCC_Claim_Actions_NewActivity_Warning, "moveToElement", "moveToElement");
				GuidewireAutomate("Unable to close the claim or the exposure", MenuCC_Claim_Actions_NewActivity_Warning_UnableToCloseTheClaimOrTheExposure, "click", "click");
				break;
			...
			case "Collision Limited Coverage" :
				...
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType C", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_C, "moveToElement", "moveToElement");
				GuidewireAutomate("Collision Limited Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_C_CollisionLimitedCoverage, "click", "click");
				break;
			case "Comprehensive" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType C", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_C, "moveToElement", "moveToElement");
				GuidewireAutomate("Comprehensive", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_C_Comprehensive, "click", "click");
				break;
			...
			case "Electronic Equipment" :
				...
				GuidewireAutomate("Electronic Equipment", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_E_ElectronicEquipment, "click", "click");
				break;
			case "Liability Bodily Injury" :
				...
				GuidewireAutomate("Liability Bodily Injury", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_L_LiabilityBodilyInjury, "click", "click");
				break;
			case "Liability Property Damage" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType L", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_L, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Property Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_L_LiabilityPropertyDamage, "click", "click");
				break;
			case "Liability Vehicle Damage" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType L", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_L, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Vehicle Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_L_LiabilityVehicleDamage, "click", "click");
				break;
			case "Mexico Cov BI" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
			...
			case "Mexico Cov Vehicle Damage" :
				...
				GuidewireAutomate("Choose by CoverageType M", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_M, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Coverage Limited", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_M_MexicoCoverageLimited, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Cov Vehicle Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_M_MexicoCoverageLimited_MexicoCovVehicleDamage, "click", "click");
				break;
			case "Mexico Cov Gen Damages'" :
				...
				GuidewireAutomate("Choose by CoverageType M", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_M, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Coverage Limited", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_M_MexicoCoverageLimited, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Cov Gen Damages", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_M_MexicoCoverageLimited_MexicoCovGenDamages, "click", "click");
				break;
			case "PIP Arkansas" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				...
				GuidewireAutomate("PIP Arkansas", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_P_PIPArkansas, "click", "click");
				break;
			case "PIP Delaware" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType P", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_P, "moveToElement", "moveToElement");
				GuidewireAutomate("PIP Delaware", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_P_PIPDelaware, "click", "click");
				break;
			case "PIP District of Columbia" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType P", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_P, "moveToElement", "moveToElement");
				GuidewireAutomate("PIP District of Columbia", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_P_PIPDistrictOfColumbia, "click", "click");
				break;
			case "PIP Florida" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType P", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_P, "moveToElement", "moveToElement");
				GuidewireAutomate("PIP Florida", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_P_PIPFlorida, "click", "click");
				break;
			// Other Cases Need to added here
			...
			case "Rental Car Loss of Use" :
				...
				GuidewireAutomate("Rental Car Loss of Use", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_R_RentalCarLossOfUse, "click", "click");
				break;
			case "Rental Reimbursement" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType R", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_R, "moveToElement", "moveToElement");
				GuidewireAutomate("Rental Reimbursement", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_R_RentalReimbursement, "click", "click");
				break;
			case "Tape Disc Media" :
				...
				GuidewireAutomate("Tape Disc Media", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_T_TapeDiscMedia, "click", "click");
				break;
			case "Towing and Labor" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by CoverageType", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType, "moveToElement", "moveToElement");
				GuidewireAutomate("Choose by CoverageType T", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_T, "moveToElement", "moveToElement");
				GuidewireAutomate("Towing and Labor", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverageType_T_TowingAndLabor, "click", "click");
				break;
			...
			case "Choose by Coverage" :
				...
				break;
			case "ChoosebyCoverage Policy Level Coverage" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage, "moveToElement", "moveToElement");
				...
				break;
			case "ChoosebyCoverage Liability Bodily Injury and Property Damage" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
			...
			case "ChoosebyCoverage Liability Bodily Injury" :
				...
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Bodily Injury and Property Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_LiabilityBodilyInjuryAndPropertyDamage, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Bodily Injury", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_LiabilityBodilyInjuryAndPropertyDamage_LiabilityBodilyInjury, "click", "click");
				break;
			case "ChoosebyCoverage Liability Property Damage" :
				...
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Bodily Injury and Property Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_LiabilityBodilyInjuryAndPropertyDamage, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Property Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_LiabilityBodilyInjuryAndPropertyDamage_LiabilityPropertyDamage, "click", "click");
				break;
			case "ChoosebyCoverage Liability Vehicle Damage" :
				...
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Bodily Injury and Property Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_LiabilityBodilyInjuryAndPropertyDamage, "moveToElement", "moveToElement");
				GuidewireAutomate("Liability Vehicle Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_LiabilityBodilyInjuryAndPropertyDamage_LiabilityVehicleDamage, "click", "click");
				break;
			case "ChoosebyCoverage Mexico Coverage Limited" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
			...
			case "ChoosebyCoverage Mexico Cov BI" :
				...
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Coverage Limited", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Cov BI", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited_MexicoCovBI, "click", "click");
				break;
			case "ChoosebyCoverage Mexico Cov PD" :
				...
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Coverage Limited", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Cov PD", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited_MexicoCovPD, "click", "click");
				break;
			case "ChoosebyCoverage Mexico Cov Vehicle Damage" :
				...
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Coverage Limited", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Cov Vehicle Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited_MexicoCovVehicleDamage, "click", "click");
				break;
			case "ChoosebyCoverage Mexico Cov Gen Damages" :
				...
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Coverage Limited", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited, "moveToElement", "moveToElement");
				GuidewireAutomate("Mexico Cov Gen Damages", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_MexicoCoverageLimited_MexicoCovGenDamages, "click", "click");
				break;
			...
			case "ChoosebyCoverage Uninsured Motorist Bodily Injury" :
				...
				GuidewireAutomate("Choose by Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Uninsured Motorist Bodily Injury", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_UninsuredMotoristBodilyInjury, "click", "click");
				break;
			case "ChoosebyCoverage Uninsured Motorist Property Damage" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Choose by Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Policy Level Coverage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage, "moveToElement", "moveToElement");
				GuidewireAutomate("Uninsured Motorist Property Damage", MenuCC_Claim_Actions_NewExposure_ChoosebyCoverage_PolicyLevelCoverage_UninsuredMotoristPropertyDamage, "click", "click");
				break;
			...
			case "ValidateClaimOnly Loadandsave" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Only", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimOnly Loadandsave", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly_LoadAndSave, "click", "click");
				break;
			case "ValidateClaimOnly NewLossCompletion" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Only", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimOnly NewLossCompletion", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly_NewLossCompletion, "click", "click");
				break;
			case "ValidateClaimOnly ValidForISO" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Only", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimOnly ValidForISO", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly_ValidForISO, "click", "click");
				break;
			case "ValidateClaimOnly SendToExternalSystem" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Only", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimOnly SendToExternalSystem", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly_SendToExternalSystem, "click", "click");
				break;
			case "ValidateClaimOnly AbilityToPay" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Only", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimOnly AbilityToPay", MenuCC_Claim_Actions_ClaimActions_ValidateClaimOnly_AbilityToPay, "click", "click");
				break;
			case "Validate Claim Exposures" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Exposures", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures, "click", "click");
				break;
			case "ValidateClaimExposures Loadandsave" :
				...
				GuidewireAutomate("ValidateClaimExposures Loadandsave", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures_LoadAndSave, "click", "click");
				break;
			case "ValidateClaimExposures NewLossCompletion" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Exposures", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimExposures NewLossCompletion", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures_NewLossCompletion, "click", "click");
				break;
			case "ValidateClaimExposures ValidForISO" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Exposures", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimExposures ValidForISO", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures_ValidForISO, "click", "click");
				break;
			case "ValidateClaimExposures SendToExternalSystem" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Exposures", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimExposures SendToExternalSystem", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures_SendToExternalSystem, "click", "click");
				break;
			case "ValidateClaimExposures AbilityToPay" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Claim Exposures", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidateClaimExposures AbilityToPay", MenuCC_Claim_Actions_ClaimActions_ValidateClaimExposures_AbilityToPay, "click", "click");
				break;
			...
			case "ValidatePolicy Loadandsave" :
				...
				GuidewireAutomate("ValidatePolicy Loadandsave", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy_LoadAndSave, "click", "click");
				break;
			case "ValidatePolicy NewLossCompletion" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Policy", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidatePolicy NewLossCompletion", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy_NewLossCompletion, "click", "click");
				break;
			case "ValidatePolicy ValidForISO" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Policy", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidatePolicy ValidForISO", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy_ValidForISO, "click", "click");
				break;
			case "ValidatePolicy SendToExternalSystem" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Policy", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidatePolicy SendToExternalSystem", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy_SendToExternalSystem, "click", "click");
				break;
			case "ValidatePolicy AbilityToPay" :
				GuidewireAutomate("Actions", Menu_ActionsCC, "click", "click");
				GuidewireAutomate("Validate Policy", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy, "moveToElement", "moveToElement");
				GuidewireAutomate("ValidatePolicy AbilityToPay", MenuCC_Claim_Actions_ClaimActions_ValidatePolicy_AbilityToPay, "click", "click");
				break;
			...
			case "Loss Details SpecialInvestigationDetails" :
				GuidewireAutomate("Loss Details", MenuCC_Claim_LossDetails, "click", "click");
				GuidewireAutomate("Special Investigation Details", MenuCC_Claim_LossDetails_SpecialInvestigationDetails, "click", "click");
				break;
			...
			case "Invalid Coverage For Cause" :
				GuidewireAutomate("Business_Settings", MenuCC_Administration_BusinessSettings, "click", "click");
				GuidewireAutomate("Coverage Verification", MenuCC_BusinessSettings_CoverageVerification, "click", "click");
				GuidewireAutomate("Invalid Coverage For Cause", MenuCC_BusinessSettings_CoverageVerification_InvalidCoverageForCause, "click", "click");
				break;
			case "Incompatible New Exposure" :
				GuidewireAutomate("Business_Settings", MenuCC_Administration_BusinessSettings, "click", "click");
				GuidewireAutomate("Coverage Verification", MenuCC_BusinessSettings_CoverageVerification, "click", "click");
				GuidewireAutomate("Incompatible New Exposure", MenuCC_BusinessSettings_CoverageVerification_IncompatibleNewExposure, "click", "click");
				break;
			case "Possible Invalid Coverage" :
				GuidewireAutomate("Business_Settings", MenuCC_Administration_BusinessSettings, "click", "click");
				GuidewireAutomate("Coverage Verification", MenuCC_BusinessSettings_CoverageVerification, "click", "click");
				GuidewireAutomate("Possible Invalid Coverage", MenuCC_BusinessSettings_CoverageVerification_PossibleInvalidCoverage, "click", "click");
				break;
			case "Holidays" :
				GuidewireAutomate("Business_Settings", MenuCC_Administration_BusinessSettings, "click", "click");
			...
			case "Compensability Parameters" :
				GuidewireAutomate("Business_Settings", MenuCC_Administration_BusinessSettings, "click", "click");
				GuidewireAutomate("WC Parameters", MenuCC_BusinessSettings_WCParameters, "click", "click");
				GuidewireAutomate("Compensability Parameters", MenuCC_BusinessSettings_WCParameters_CompensabilityParameters, "click", "click");
				break;
			// Monitoring SubMenu
			case "Message Queues" :
