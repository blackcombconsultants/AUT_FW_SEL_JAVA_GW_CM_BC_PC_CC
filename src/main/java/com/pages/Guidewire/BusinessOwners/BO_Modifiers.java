...
public class BO_Modifiers extends SeleniumWebDriver_Commands {
	 ...
	 * ); private static By ConditionalSurcharge = By.xpath(
	 * "//div[contains(@id,'ratingInputName_Input')]//div[@class='gw-value-readonly-wrapper' and text()='Conditional Surcharge'] "
	 * ); private static By Considerationsrelatedtopolicyexpenses = By.
	 * xpath("//div[contains(@id,'Category')]//div[@class='gw-value-readonly-wrapper' and text()='Considerations related to policy expenses']"
	 * ); private static By CreditDebit = By.xpath(
	 * "//input[contains(@name,'ScheduleRateDV-0-ScheduleRateLV-0-CreditDebit')]");
	 */

	
	private static By Modifier = By.xpath(
			"//div[contains(@id,'ScheduleRateDV-1-ratingInputName_Input')]//div[@class='gw-label gw-boldLabel' and text()='Modifier'] ");
	private static By ScheduleModifier = By.xpath(
			"//div[contains(@id,'ratingInputName_Input')]//div[@class='gw-value-readonly-wrapper' and text()='Schedule Rates'] ");
	private static By RI_Buildingfeatures = By.xpath(
			"//div[contains(@id,'Category')]//div[@class='gw-value-readonly-wrapper' and text()='Building features']");
	private static By RI_LIP_Minimum = By.xpath(
			"//div[contains(text(),'Building features')]//ancestor::td//following-sibling::td[contains(@id,'Minimum_Cell')]//div[@class='gw-value-readonly-wrapper']");
	private static By RI_LIP_Maximum = By.xpath(
			"//div[contains(text(),'Building features')]//ancestor::td//following-sibling::td[contains(@id,'Maximum_Cell')]//div[@class='gw-value-readonly-wrapper']");
	private static By RI_LIP_CreditDebit = By.xpath(
			"//div[contains(text(),'Building features')]//ancestor::td//following-sibling::td[contains(@id,'CreditDebit_Cell')]//input[contains(@name,'CreditDebit')]");
	private static By RI_LIP_Justification = By.xpath(
			"//div[contains(text(),'Building features')]//ancestor::td//following-sibling::td[contains(@id,'Justification_Cell')]//input[contains(@name,'Justification')]");
