...
public class ClaimCenter_SearchPolicy extends SeleniumWebDriver_Commands implements ClaimCenter_SearchPolicy_PO {
	...
	public static void fnol_Search_Exitsing_Policy() throws Throwable {
		...
		GuidewireAutomate("Policy Number", SP_FP_PolicyNumber, "clearANDsendKeys",
		...
		By TypeOfClaim = By.xpath("//span[@class='gw-label--inner' and text()='" + strDynamicXpath
	...
	public static void fnol_Search_UnverifiedPolicy() throws Throwable {
		...
		GuidewireAutomate("PolicyNumber", CUP_PolicyNumber, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("PolicyNumber"));
		...
		GuidewireAutomate("ExpirationDate", CUP_BI_EffectiveDate, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("EffectiveDate"));
		GuidewireAutomate("ExpirationDate", CUP_BI_ExpirationDate, "clearANDsendKeys",
	...
	public static void SearchPolicy_InsuredName() throws Throwable {
		...
		GuidewireAutomate("LastName", CUP_Insured_NewPerson_LastName, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("LastName"));
		GuidewireAutomate("TaxID", CUP_Insured_NewPerson_TaxID, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("TaxID"));
		GuidewireAutomate("Address1", CUP_Insured_NewPerson_Address1, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("Address1"));
		GuidewireAutomate("City", CUP_Insured_NewPerson_City, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("City"));
		GuidewireAutomate("County", CUP_Insured_NewPerson_County, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("County"));
		GuidewireAutomate("State", CUP_Insured_NewPerson_State, "selectByVisibleText",
				lhm_TestCase_Table_Data.get("State"));
		GuidewireAutomate("ZIPCode", CUP_Insured_NewPerson_ZIPCode, "clearANDsendKeys",
