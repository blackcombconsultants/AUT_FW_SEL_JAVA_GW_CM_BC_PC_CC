...
public class CC_ChooseCoverage extends SeleniumWebDriver_Commands implements CC_ChooseCoverage_PO {
	...
	public static void AllClaimant() throws Throwable {
		...
		try {
			...
			GuidewireAutomate("Select Claimant", EditIncidentClaimant, "selectByVisibleText", lhm_TestCase_Table_Data.get("ClaimantName"));
	...
	public static void InjuryNewIncident() throws Throwable {
		lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("newExposure", strTestCaseName);
		try {
			GuidewireAutomate_Validation("Injury Incident Overview", NewIncident_InjuryIncidentOverviewTitle, "equals", "Injury Incident Overview");
