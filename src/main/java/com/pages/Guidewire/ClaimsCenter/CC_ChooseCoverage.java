...
public class CC_ChooseCoverage extends SeleniumWebDriver_Commands implements CC_ChooseCoverage_PO {
	...
	public static void NewExposureValidation() throws Throwable {
		lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("newExposure",
				strTestCaseName);
		try {
			String HeaderText = getElement(NewExposureHeader).getText();
			GuidewireAutomate_Validation("NewExposur Header", NewExposureHeader, "equals", HeaderText);
			GuidewireAutomate_Validation("Exposure Title", ExposureTitle, "equals", "Exposure");
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		}
	...
	public static void VehicleNewIncident() throws Throwable {
		...
		try {
			GuidewireAutomate_Validation("IncidentOverview Title", EditIncident_IncidentOverviewTitle, "equals",
					"Incident Overview");
			GuidewireAutomate("NewIncident Button", EditIncident_VehicleEditButton, "clickAndwait", "clickAndwait");
			GuidewireAutomate("New Incident", EditIncident_VehicleNewIncident, "clickAndwait", "clickAndwait");
	...
	public static void VehicleEditIncident() throws Throwable {
		...
		try {
			GuidewireAutomate_Validation("IncidentOverview Title", EditIncident_IncidentOverviewTitle, "equals",
					"Incident Overview");
			GuidewireAutomate("Edit Incident Button", EditIncident_VehicleEditButton, "clickAndwait", "clickAndwait");
			GuidewireAutomate("Edit Incident", EditIncident_VehicleEditIncident, "clickAndwait", "clickAndwait");
	...
	public static void InjuryNewIncident() throws Throwable {
		...
		try {
			...
			GuidewireAutomate("EditIncident Button", NewIncident_InjuryEditButton, "clickAndwait", "clickAndwait");
			GuidewireAutomate("Edit Incident", EditIncident_VehicleNewIncident, "clickAndwait", "clickAndwait");
