...
public class CC_Negotiations extends SeleniumWebDriver_Commands {
	...
	public static void NewNegotiation() throws Throwable {
		...
		lhm_TestCase_Table_Data = CC_Reusables.getData_ClaimsCenter("NewNegotiation");
	 ...
	 * Owner: Pankaj
	 */
	public static void Negotiation_Lines_Typeverify() throws Throwable {
		...
		try {
			...
			GuidewireAutomate("Add Button", NN_AddButton, "clickAndwait", "clickAndwait");
			Thread.sleep(1000);
			String TypeList = getOptions_Element(NN_Type);
			String Type1    = "Judgement/Award";
			String Type2    = "Executed Settlement";

			if (TypeList.contains(Type1) && TypeList.contains(Type2)) {

				oExtentTest.log(Status.PASS, "Negotiation Lines Type List:- " + Type1 + " ," + Type2 + " Values Added");
			} else {
				oExtentTest.log(Status.FAIL, "Negotiation Lines Type List:- " + Type1 + " ," + Type2 + " Values Not Added");
			}
