...
public class Admininstration_Groups extends SeleniumWebDriver_Commands {
	...
	public Admininstration_Groups(WebDriver driver, ExtentTest oExtentTest) {
	...
	private static By GD_Profile_Tab = By.xpath("//div[contains(@id,'GroupDetail_BasicCardTab')]/div[@role='tab']");

	/*
	 * 
	 */
	private static By GR_GroupsName = By.xpath(" //input[contains(@name,'GroupName')]");
	private static By GR_GroupType  = By.xpath(" //input[contains(@name,'GroupType')]");
	private static By GR_Search     = By.xpath("//div[contains(@id,'SearchLinksInputSet-Search')]");
	private static By GR_Reset      = By.xpath("//div[contains(@id,'SearchLinksInputSet-Reset')]");

	/*
	 * 
	 */
	private static By Groups_GroupName_Users          = By.xpath("//table[@class='gw-ListViewWidget--table gw-table']//tr[contains(@id,'GroupUsersLV')]//td[contains(@id,'User_Cell')]//div[@class='gw-link gw-label']");
	private static By Groups_GroupName_LoadFactor     = By.xpath("//table[@class='gw-ListViewWidget--table gw-table']//tr[contains(@id,'GroupUsersLV')]//td[contains(@id,'LoadFactor_Cell')]//div[@class='gw-value-readonly-wrapper']");
	private static By Groups_GroupName_VacationStatus = By.xpath("//table[@class='gw-ListViewWidget--table gw-table']//tr[contains(@id,'GroupUsersLV')]//td[contains(@id,'VacationStatus_Cell')]//div[@class='gw-label']");

	private static By Edit_Button = By.xpath("//div[contains(@id,'GroupDetailToolbarButtonSet-Edit')]");

	/*
	 * After Edit
	 */
	private static By Groups_GroupName_CheckBox = By
	...
	private static By Groups_GroupName_Users_Edit                   = By
			.xpath("//table[@class='gw-ListViewWidget--table gw-table']//tr[contains(@id,'GroupUsersLV')]/td[contains(@id,'GroupUsers_User_Cell')]//select[contains(@name,'GroupUsers_User')]");
	private static By Groups_GroupName_LoadFactor_Edit              = By.xpath("//tr[contains(@id,'GroupUsersLV')]//input[contains(@name,'LoadFactor')]");
	private static By Groups_GroupName_LoadFactorParameterType_Edit = By.xpath("//tr[contains(@id,'GroupUsersLV')]//select[contains(@name,'LoadFactorType')]");
	private static By Groups_GroupName_VacationStatus_Edit          = By.xpath("//tr[contains(@id,'GroupUsersLV')]//select[contains(@name,'VacationStatus')]");
	private static By Groups_GroupName_BackupUser                   = By.xpath("//tr[contains(@id,'GroupUsersLV')]//select[contains(@name,'BackupUser')]");

	/*
	 * 
	 */

	private static By G_GN_U_Edit_BackUpUser_SearchUser_Header    = By.xpath("//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading']");
	private static By G_GN_U_Edit_BackUpUser_SearchUser_FirstName = By.xpath("//input[contains(@name,'FirstName')]");
	private static By G_GN_U_Edit_BackUpUser_SearchUser_LastName  = By.xpath("//input[contains(@name,'LastName')]");
	private static By G_GN_U_Edit_BackUpUser_SearchUser_Search    = By.xpath("//div[contains(@id,'SearchLinksInputSet-Search')]");
	private static By G_GN_U_Edit_BackUpUser_SearchUser_Select    = By.xpath("//div[text()='Andy Applegate']/ancestor::td[contains(@id,'DisplayName_Cell')]/preceding-sibling::td//div[contains(@id,'_Select')]/div[@role='button']");
	 ...
	 * Queues
	 */
	private static By GN_Queues_Tab = By.xpath("//div[contains(@id,'GroupDetail_QueuesCardTab')]/div[@role='tab']");

	private static By Queue_Name               = By.xpath("//td[contains(@id,'GroupQueuesLV-0-Name_Cell')]//div[contains(@id,'Name_button')]");
	private static By Queue_Description        = By.xpath("//td[contains(@id,'GroupQueuesLV-0-Description_Cell')]//div[contains(@id,'Description')]");
	private static By Queue_VisibleInSubgroups = By.xpath("//td[contains(@id,'GroupQueuesLV-0-SubGroupVisible_Cell')]//div[contains(@id,'SubGroupVisible')]");

	/*
	 * Regions
	 */
	private static By GN_Regions_Tab = By.xpath("//div[contains(@id,'GroupDetail_RegionsCardTab')]/div[@role='tab']");

	private static By GN_Regions_Name         = By.xpath("//tr[contains(@id,'GroupRegionLV')]/td[contains(@id,'Name_Cell')]//div[contains(@id,'Name')]");
	private static By GN_Regions_AreasCovered = By.xpath("//tr[contains(@id,'GroupRegionLV')]/td[contains(@id,'Zones_Cell')]//div[contains(@id,'Zones')]");
	...
	public static void groupName_ProfileTab() throws Throwable {
		...
		try {
			...
			GuidewireAutomate_Validation("Screen Header", CC_Reusables.Screen_Header, "equals", strGroupName);
	...
	public static void LoadFactor_VacationStatus_OnVacationandAssignBackUpUser() throws Throwable {
		...
		if (bEditUser) {
			...
			// VacationStatus_Edit(lhmVacationStatus);
			Group_BackupUser();
			GuidewireAutomate_Validation("Screen Header", CC_Reusables.Screen_Header, "equals", "Auto1 - TeamB");
			GuidewireAutomate("Update_Button", Update_Button, "clickAndwait", "click");
			oListWebElement_Users          = getElements(Groups_GroupName_Users);
			oListWebElement_loadFactor     = getElements(Groups_GroupName_LoadFactor);
			oListWebElement_vacationStatus = getElements(Groups_GroupName_VacationStatus);
