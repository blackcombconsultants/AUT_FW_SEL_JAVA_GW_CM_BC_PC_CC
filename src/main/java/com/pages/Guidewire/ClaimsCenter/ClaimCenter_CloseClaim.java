...
public class ClaimCenter_CloseClaim extends SeleniumWebDriver_Commands implements ClaimCenter_CloseClaim_PO {

	public ClaimCenter_CloseClaim(WebDriver driver, ExtentTest oExtentTest) {
