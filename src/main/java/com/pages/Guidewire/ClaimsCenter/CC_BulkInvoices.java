...
public class CC_BulkInvoices extends SeleniumWebDriver_Commands {
	...
	// Bulk Invoices
	private static By BulkInvoices_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Bulk Invoices']");
	private static By BI_CreateNew = By.xpath("//div[contains(@id,'CreateNewButton')]/div[@role='button']");

	// Bulk Invoice Details
	private static By BID_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Bulk Invoice Details']");
	...
	private static By BID_I_Distribution_Distributeamountevenly = By
			.xpath("//input[contains(@id,'BulkInvoiceDetailDV-SplitEqually_0')]");
	private static By BID_I_Distribution_Amounttodistribute = By
			.xpath("//input[contains(@name,'BulkInvoiceDetailDV-TotalAmount')]");

	// BID Invoice Item Details
	private static By BID_IID_DefaultCostType = By
			.xpath("//select[contains(@name,'BulkInvoiceDetailDV-DefaultCostType')]");
	private static By BID_IID_DefaultCostCategory = By
			.xpath("//select[contains(@name,'BulkInvoiceDetailDV-DefaultCostCategory')]");
	private static By BID_IID_DefaultPaymentType = By
			.xpath("//select[contains(@name,'BulkInvoiceDetailDV-DefaultPaymentType')]");

	// Check Details
	private static By CD_Payee = By.xpath(
			"//div[contains(@id,'PaymentMethodInputSet-Payee')]//div[@class='gw-value-readonly-wrapper' and text()='<none selected>']");
	...
	// Search Address Book
	private static By SearchAddressBook_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Search Address Book']");
	...
	private static By PI_CheckInstructions = By
			.xpath("//select[contains(@name,'BulkInvoiceDetailDV-CheckInstructions')]");
	...
	private static By AddClaim = By.xpath(
			"//div[contains(@id,'BulkInvoiceItemsLV_ClaimNumberMenuIcon')]//div[@class='gw-action--expand-button']");
	...
	private static By Status = By
			.xpath(" //div[contains(@id,'BulkInvoiceItemsLV-0-BulkInvoiceItemsLV_Status')]//div[@class='gw-label']");
	private static By Update=By.xpath("//div[contains(@id,'BulkInvoiceDetailScreen-Update')]");
	
	// Search Claims
	private static By SC_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Search Claims']");
	...
	public static void BulkInvoices_CreateNew() throws Throwable {
		try {
			...
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("bulkInvoices",
					strTestCaseName);
	...
	public static void BID_Invoice() throws Throwable {
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("bulkInvoices",
					strTestCaseName);
			GuidewireAutomate("Invoice", BID_I_Invoice, "clearANDsendKeys",
					lhm_TestCase_Table_Data.get("BID_I_Invoice"));
			GuidewireAutomate("DateReceived", BID_I_DateReceived, "clearANDsendKeys",
					lhm_TestCase_Table_Data.get("BID_I_DateReceived"));
			GuidewireAutomate("Distribute amount evenly", BID_I_Distribution_Distributeamountevenly, "click", "click");
			GuidewireAutomate("Amount to distribute", BID_I_Distribution_Amounttodistribute, "clearANDsendKeys",
					lhm_TestCase_Table_Data.get("BID_I_Distribution_Amounttodistribute"));
		} catch (Exception e) {
	...
	public static void BID_InvoiceItemDetails() throws Throwable {
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("bulkInvoices",
					strTestCaseName);
			GuidewireAutomate_Validation("DefaultCostType Values", BID_IID_DefaultCostType, "getOptionscontains",
					lhm_TestCase_Table_Data.get("BID_IID_DefaultCostType_Values"));
			GuidewireAutomate("Default Cost Type", BID_IID_DefaultCostType, "selectByVisibleText",
					lhm_TestCase_Table_Data.get("BID_IID_DefaultCostType"));

			GuidewireAutomate_Validation("DefaultCostCategory Values", BID_IID_DefaultCostCategory,
					"getOptionscontains", lhm_TestCase_Table_Data.get("BID_IID_DefaultCostCategory_Values"));
			GuidewireAutomate("Default Cost Category", BID_IID_DefaultCostCategory, "selectByVisibleText",
					lhm_TestCase_Table_Data.get("BID_IID_DefaultCostCategory"));

			GuidewireAutomate_Validation("DefaultPaymentType Values", BID_IID_DefaultPaymentType, "getOptionscontains",
					lhm_TestCase_Table_Data.get("BID_IID_DefaultPaymentType_Values"));
			GuidewireAutomate("Default PaymentType", BID_IID_DefaultPaymentType, "selectByVisibleText",
					lhm_TestCase_Table_Data.get("BID_IID_DefaultPaymentType"));
		} catch (Exception e) {
	...
	public static void CheckDetails_Search() throws Throwable {
		try {
			...
			GuidewireAutomate("FirstName", SAB_FirstName, "clearANDsendKeys",
					lhm_TestCase_Table_Data.get("SAB_FirstName"));
			GuidewireAutomate("LastName", SAB_LastName, "clearANDsendKeys",
					lhm_TestCase_Table_Data.get("SAB_LastName"));
			...
			GuidewireAutomate_Validation("Delivery Method", CD_DeliveryMethod, "getOptionscontains",
					lhm_TestCase_Table_Data.get("CD_DeliveryMethod_Values"));
			GuidewireAutomate("Delivery Method", CD_DeliveryMethod, "selectByVisibleText",
					lhm_TestCase_Table_Data.get("CD_DeliveryMethod"));
	...
	public static void BID_PaymentInstructions() throws Throwable {
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("bulkInvoices",
					strTestCaseName);
			GuidewireAutomate("Check Instructions", PI_CheckInstructions, "selectByVisibleText",
					lhm_TestCase_Table_Data.get("PI_CheckInstructions"));
	...
	public static void BID_Add() throws Throwable {
		try {
			...
			GuidewireAutomate("ReserveLine", ReserveLine, "selectByVisibleText",
			...
			GuidewireAutomate_Validation("Payment Type", PaymentType, "FirstSelectedOptionEquals",
			...
			GuidewireAutomate("ServiceDate", ServiceDate, "clearANDsendKeys",
					lhm_TestCase_Table_Data.get("ServiceDate"));
			GuidewireAutomate("Description", Description, "clearANDsendKeys",
