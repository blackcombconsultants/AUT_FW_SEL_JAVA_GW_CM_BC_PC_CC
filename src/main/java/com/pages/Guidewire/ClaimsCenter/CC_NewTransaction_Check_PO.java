...
public interface CC_NewTransaction_Check_PO {
	...
	final By ValidationResults_Warning_Second  = By.xpath("//div[contains(@id,'WebMessageWorksheetScreen-grpMsgs-0-1')]//div[@class='gw-message' and contains(text(),'This check would cause gross incurred on coverage')]");
