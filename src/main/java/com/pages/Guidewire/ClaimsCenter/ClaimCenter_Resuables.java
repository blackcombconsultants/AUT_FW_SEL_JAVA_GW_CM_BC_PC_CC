...
public class ClaimCenter_Resuables extends SeleniumWebDriver_Commands implements ClaimCenter_Resuables_PO {
	...
	public static void repairShop() throws Throwable
	{
		...
		GuidewireAutomate("City", AFF_AutoRepairShop_City, "clearANDsendKeys",
...
//		GuidewireAutomate("Rental BeginDate", SR_RentalBeginDate, "clearANDsendKeys",  lhm_TestCase_Table_Data.get("RentalBeginDate"));
//		GuidewireAutomate("Rental EndDate", SR_RentalEndDate, "clearANDsendKeys",  lhm_TestCase_Table_Data.get("RentalEndDate"));
//		GuidewireAutomate("Rental DailyRate", SR_RentalDailyRate, "clearANDsendKeys",  lhm_TestCase_Table_Data.get("RentalDailyRate"));
//		GuidewireAutomate("Rental Agency", SR_RentalAgency, "selectByVisibleText",  lhm_TestCase_Table_Data.get("RentalAgency"));
//	    GuidewireAutomate("Pick upLocation", SR_PickupLocation, "selectByVisibleTextAndwait",  lhm_TestCase_Table_Data.get("PickupLocation"));
//		
		}
