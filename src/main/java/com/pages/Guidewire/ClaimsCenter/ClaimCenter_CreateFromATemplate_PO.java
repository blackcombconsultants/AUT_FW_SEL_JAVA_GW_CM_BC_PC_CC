...
public interface ClaimCenter_CreateFromATemplate_PO {
	...
	final By NewDocument_Type = By
			.xpath("//select[contains(@name, 'DocumentTemplateSearchDV-TemplateType')]");
	final By NewDocument_LineOfBusiness = By
			.xpath("//select[contains(@name, 'DocumentTemplateSearchDV-LossType')]");
	final By NewDocument_Jurisdiction = By
	...
	final By NewDocument_Select_AcrobatSample = By.xpath(
	...
	final By NewDocument_Select_GosuCSVSample = By.xpath(
	...
	final By NewDocument_Select_KYSample= By.xpath("//div[@class='gw-value-readonly-wrapper' and text()='KY No Fault App 1-03 - FCCI']/ancestor::td[contains(@id,'Template_Cell')]/preceding-sibling::td//div[contains(@id,'Select')]/div[@role='button']");
	
	final By NewDocument_CreateDocument = By
