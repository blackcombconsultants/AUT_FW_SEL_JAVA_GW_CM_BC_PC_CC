...
public class GL_PolicyInfo extends SeleniumWebDriver_Commands {

	public GL_PolicyInfo(WebDriver driver, ExtentTest oExtentTest) {
		super(driver, oExtentTest);
		// TODO Auto-generated constructor stub
	}

	private static By PolicyInfo_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Policy Info']");
	...
	private static By PI_PNI = By
			.xpath("//div[contains(@id,'ChangePrimaryNamedInsuredButton_Input')]/div[ text()='Primary Named Insured']");
	private static By PI_PNI_Name = By
			.xpath("//div[contains(@id,'AccountInfoInputSet-Name')]//div[ @class='gw-ActionValueWidget']");
	private static By PI_PNI__AddressType = By.xpath(
			"//div[contains(@id,'AddressType') and contains(@class,'gw-ValueWidget')]//div[contains(@class,'gw-label')]");

	// Business and Operations
	private static By PI_BO = By
			.xpath("//div[contains(@id,'CommercialInputSet-1')]/div[ text()='Business and Operations']");

	private static By PI_OrganizationType = By
			.xpath("//select[contains(@name,'PolicyInfoDV-AccountInfoInputSet-OrganizationType')]");

	// Official IDs
	private static By PI_OfficialID = By.xpath(
	...
	private static By PI_PD_TermNumber = By.xpath(
	...
	private static By PI_PD_ExpirationDate = By.xpath(
	...
	private static By PI_PD_RateAsOfDate = By.xpath(
			"//div[contains(@id,'PolicyInfoInputSet-RateAsOfDate')]//div[contains(@class,'gw-value-readonly-wrapper')]");
	private static By PI_PD_PrefferedLanguage = By
			.xpath("//select[contains(@name,'PolicyInfoInputSet-PrimaryLanguage')]");

	// Producer of Record
	private static By PI_ProducerofRecord = By
			.xpath("//div[contains(@class,'gw-boldLabel') and text()='Producer of Record']");
	private static By PI_PR_Organization = By
			.xpath("//input[contains(@name,'PolicyInfoProducerOfRecordInputSet-Producer')]");
	private static By PI_PR_ProducerCode = By
			.xpath("//select[contains(@name,'PolicyInfoProducerOfRecordInputSet-ProducerCode')]");

	// Underwriting Companies
	private static By PI_UnderwritingCompanies = By
	...
	public static void dateQuoteNeeded() throws Throwable {
		...
		try {
			...
			GuidewireAutomate("Date Quote Needed", PI_DateQuoteNeeded, "clearANDsendKeys",
	...
	public static void primaryNamedInsured() throws Throwable {
		try {
			...
			GuidewireAutomate_Validation("Name", PI_PNI_Name, "equals", lhm_TestCase_Table_Data.get("PI_PNI_Name"));
			GuidewireAutomate_Validation("AddressType", PI_PNI__AddressType, "equals",
					lhm_TestCase_Table_Data.get("PI_PNI__AddressType"));
	...
	public static void OrganizationType() throws Throwable {
		try {
			...
			GuidewireAutomate("OrganizationType", PI_OrganizationType, "selectByVisibleText",
					lhm_TestCase_Table_Data.get("PI_OrganizationType"));
			/*
			 * GuidewireAutomate("Description", PI_Description, "clearANDsendKeys",
			 * lhm_TestCase_Table_Data.get("PI_Description"));
			 */
	...
	public static void policyDetails() throws Throwable {
		...
		GuidewireAutomate_Validation("Term Type", PI_PD_TermType, "FirstSelectedOptionEquals",
