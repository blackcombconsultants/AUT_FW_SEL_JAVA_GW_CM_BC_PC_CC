...
public class GL_Exposures extends SeleniumWebDriver_Commands {
	...
	private static By Exposures_Header = By.xpath(
	...
	private static By EVL_EffectiveDate = By.xpath(
			"//div[contains(@id,'GL_ExposureUnitsLV-0-EffectiveDate')]//div[@class='gw-value-readonly-wrapper']");
	private static By EVL_ExperationDate = By.xpath(
			"//div[contains(@id,'GL_ExposureUnitsLV-0-ExpirationDate')]//div[@class='gw-value-readonly-wrapper']");
	...
	// Class Code Search
	private static By ClassCodeSearch_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Class Code Search']");
	...
	private static By CCS_Select = By
			.xpath("//div[contains(@id,'ClassCodeSearchResultsLV-0-_Select')]/div[@role='button']");

	private static By EVL_Description = By.xpath(
			"//div[contains(@id,'GL_ExposureUnitsLV-0-ClassCodeDescription')]//div[@class='gw-value-readonly-wrapper']");
	private static By EVL_Basics = By.xpath("//input[contains(@name,'GL_ExposureUnitsLV-0-BasisAmount')]");
	private static By EVL_BasicType = By
			.xpath("//div[contains(@id,'ClassCodeUnits')]//div[@class='gw-value-readonly-wrapper']");

	public static void ExposureValuesbylocation_Add() throws Throwable {
		try {

			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("Exposures",
					strTestCaseName);
			GuidewireAutomate_Validation("Screen Header", Exposures_Header, "equals", "Exposures");
			GuidewireAutomate("Add", EVL_Add, "click", "click");
			GuidewireAutomate_Validation("EffectiveDate", EVL_EffectiveDate, "equals",
					lhm_TestCase_Table_Data.get("EVL_EffectiveDate"));
			GuidewireAutomate_Validation("ExperationDate", EVL_ExperationDate, "equals",
					lhm_TestCase_Table_Data.get("EVL_ExperationDate"));
			GuidewireAutomate("LocationName", EVL_LocationName, "selectByIndex",
					"1");
			ClassCode_Search();
			getStaleElement("Description", EVL_Description);
			GuidewireAutomate_Validation("Description", EVL_Description, "equals",
					lhm_TestCase_Table_Data.get("EVL_Description"));
