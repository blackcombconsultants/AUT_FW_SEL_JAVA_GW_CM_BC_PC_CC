...
public class GL_Coverages extends SeleniumWebDriver_Commands {
	...
	private static By Coverages_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Coverages']");
	// Standard Coverages
	...
	public static void StandardCoverages() throws Throwable {
		try {
			...
			GuidewireAutomate_Validation("Policy Basis", SC_PolicyBasis, "FirstSelectedOptionEquals",
					lhm_TestCase_Table_Data.get("SC_PolicyBasis"));
