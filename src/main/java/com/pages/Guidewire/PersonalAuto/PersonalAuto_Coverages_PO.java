...
public interface PersonalAuto_Coverages_PO {
  ...
  //--->PA_Coverages_CheckBox tabs
    ...
    final By PA_Coverages_Rental_Car_Loss_of_Use_CheckBox=By.xpath("//div[contains(@id,'PALineAdditionalCoveragesDV-0-0-CoverageInputSet-CovPatternInputGroup-_checkbox')]//input");
    final By PA_Coverages_Coverage_CheckBox=By.xpath("//div[contains(@id,'CoveragePatternSearchResultsLV-_Checkbox')]//input");
    ...
    final By PA_Coverages_Coverages_applied_per_vehicle_in_alaska_titlevalidation=By.xpath("//div[text()='Coverages applied to all vehicles in Alaska']");
    final By PA_Coverages_Rental_Car_Loss_of_Use_Limit=By.xpath("//select[contains(@name,'CovTermInputSet-OptionTermInput')]");

    final By PA_Coverages_SearchButton=By.xpath("//div[contains(@id,'SearchLinksInputSet-Search')]");
    final By PA_Coverages_Add_Selected_Exclusions_And_Conditions_button=By.xpath("//div[contains(@id,'AddCoverageButton')]");

    void pac_CoveragesAppliedtoallvehicles() throws Throwable;
    void pac_SearchAddExclusionorCondition()throws Throwable;
