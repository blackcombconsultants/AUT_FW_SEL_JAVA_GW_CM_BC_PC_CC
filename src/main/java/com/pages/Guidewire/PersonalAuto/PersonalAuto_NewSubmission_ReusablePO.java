...
public interface PersonalAuto_NewSubmission_ReusablePO {
	...
	final By OfferingSelection = By.xpath("//select[@name='SubmissionWizard-OfferingScreen-OfferingSelection']");

	final By Qualification_Screen_Header = By.xpath("div[class='gw-TitleBar--title']");
	final By IstApplicantCurrentlyInsured = By
			.xpath("//input[contains(@id,'QuestionSetLV-1-QuestionModalInput-BooleanRadioInput_NoPost_1')]");
	final By IsApplicantLicenseCurrently_suspended_canceled_Rrevoked = By
			.xpath("//input[contains(@id,'QuestionSetLV-1-QuestionModalInput-BooleanRadioInput_NoPost_1')]");
	final By Has_the_applicants_license_ever_been_canceled_suspended_or_revoked = By
			.xpath("//input[contains(@id,'QuestionSetLV-2-QuestionModalInput-BooleanRadioInput_NoPost_1')]");
	final By Anydriverswithconvictionsformovingtrafficviolationswithinthepast3years = By
			.xpath("//input[contains(@id,'QuestionSetLV-3-QuestionModalInput-BooleanRadioInput_1')]");
	final By Hasanypolicyorcoveragebeendeclined_canceled_NonRenewedduringtheprior3years = By
