...
public class PersonalAuto_RiskAnalysis extends SeleniumWebDriver_Commands implements PersonalAuto_RiskAnalysis_PO {
	...
	public static void addUWIssue() throws Throwable {
		...
		lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("riskAnalysis",
				strTestCaseName);
	...
	public static void addUWContingency() throws Throwable {
		 ...
		 * GuidewireAutomate_Validation("Potential Action", RA_C_PotentialAction,
		 * "equals", lhm_TestCase_Table_Data.get("RA_C_PotentialAction"));
	...
	public static void releaseLock() throws Throwable {
		...
		GuidewireAutomate_Validation("Subject", RA_UWA_Subject, "valueEquals",
				lhm_TestCase_Table_Data.get("RA_UWA_Subject"));

		GuidewireAutomate("Description", RA_UWA_Description, "sendKeys",
				lhm_TestCase_Table_Data.get("RA_UWA_Description"));
		GuidewireAutomate("Due Date", RA_UWA_DueDate, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("RA_UWA_DueDate"));
		GuidewireAutomate("Escalation Date", RA_UWA_EscalationDate, "clearANDsendKeys",
				lhm_TestCase_Table_Data.get("RA_UWA_EscalationDate"));
		GuidewireAutomate("Priority", RA_UWA_Priority, "selectByVisibleText",
		...
		GuidewireAutomate("Assign To", RA_UWA_AssignTo, "selectByVisibleText",
				lhm_TestCase_Table_Data.get("RA_UWA_AssignTo"));

		GuidewireAutomate_Validation("New Note", RA_UWA_NewNote, "equals", "New Note");
		GuidewireAutomate("Topic", RA_UWA_NN_Topic, "selectByVisibleText",
				lhm_TestCase_Table_Data.get("RA_UWA_NN_Topic"));
		GuidewireAutomate("Subject", RA_UWA_NN_Subject, "sendKeys", lhm_TestCase_Table_Data.get("RA_UWA_NN_Subject"));
		GuidewireAutomate("Security Level", RA_UWA_NN_SecurityLevel, "selectByVisibleText",
				lhm_TestCase_Table_Data.get("RA_UWA_NN_SecurityLevel"));
