...
public interface PersonalAuto_RiskAnalysis_PO {
	...
	final By RA_Error_header  = By.xpath("//div[@class='gw-subGroupLabel gw-text' and text()='Errors on current page:']");
	 ...
	 * CreateNewUWIssue
	 */
	final By RA_AddUWIssue_Button    = By.xpath("//div[contains(@id,'RiskAnalysisCV_tb-AddManualIssue')]//div[@class='gw-label' and text()='Add UW Issue']");
	...
	final By RA_UI_ViewIssuesBlocking = By.xpath("//div[contains(@id,'RiskEvaluationPanelSet-UserViewFilter')]//select[contains(@name,'UserViewFilter')]");
	 ...
	 * NewApproval
	 */
	final By RAD_NewApproval = By.xpath("//div[contains(@class,'gw-ListView--UI--title') and @role = 'heading' and text()='New Approval']");
	 ...
	 * History
	 */
	final By RAD_History = By.xpath("//div[contains(@class,'gw-ListView--UI--title') and @role = 'heading' and text()='History']");

	final By RAD_H_User              = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'ResponsibleUser_Cell')]//div[contains(@id,'ResponsibleUser')]//div[@class='gw-value-readonly-wrapper']");
	final By RAD_H_Date              = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'HistoryCreateDate_Cell')]//div[contains(@id,'HistoryCreateDate')]//div[@class='gw-value-readonly-wrapper']");
	final By RAD_H_EffectiveDate     = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'HistoryEffDate_Cell')]//div[contains(@id,'HistoryEffDate')]//div[@class='gw-value-readonly-wrapper']");
	final By RAD_H_PolicyTransaction = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'Job_Cell')]//div[contains(@id,'Job')]//div[@class='gw-value-readonly-wrapper']");
	final By RAD_H_AllowEdit         = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'EditBeforeBind_Cell')]//div[contains(@id,'EditBeforeBind')]/div");
	final By RAD_H_Though            = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'ThroughValue_Cell')]//div[contains(@id,'ThroughValue')]//div[@class='gw-value-readonly-wrapper']");
	final By RAD_H_ValidUntil        = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'InvalidFrom_Cell')]//div[contains(@id,'InvalidFrom')]/div");
	final By RAD_H_Status            = By.xpath("//tr[contains(@id,'UWIssueHistoryLV')]/td[contains(@id,'HistoryStatus_Cell')]//div[contains(@id,'HistoryStatus')]//div[@class='gw-label']");

	/*
	 * Contingencies
	 */

	final By RA_AddContingency_Button = By.xpath("//div[contains(@id,'RiskAnalysisCV_tb-AddNewContingencyButton')]//div[@class='gw-label' and text()='Add Contingency']");
	...
	final By RA_AC_NC_DueDate     = By.xpath("//input[contains(@class,'dateInput') and contains(@name,'ContingencyDueDate')]");
	...
	final By RA_C_Pending         = By.xpath("//div[contains(@class,'gw-ListView--UI-section')]//div[@class='gw-ListView--UI--title' and @role='heading' and text()='Pending']");
	final By RA_C_Title           = By.xpath("//td[contains(@id,'ContingencyTitle_Cell')]//div[contains(@id,'ContingencyTitle') and contains(@class,'gw-actionValue')]//div[contains(@id,'ContingencyTitle_button')]");
	 ...
	 * UW Activity
	 */
	final By RA_UWA_Subject        = By.xpath("//input[contains(@name,'NewActivityDV-Subject')]");
	final By RA_UWA_Description    = By.xpath("//input[contains(@name,'NewActivityDV-Description')]");
	final By RA_UWA_DueDate        = By.xpath("//input[contains(@name,'NewActivityDV-TargetDate')]");
	final By RA_UWA_EscalationDate = By.xpath("//input[contains(@name,'NewActivityDV-EscalationDate')]");
	final By RA_UWA_Priority       = By.xpath("//select[contains(@name,'NewActivityDV-Priority')]");
	final By RA_UWA_Mandatory_Yes  = By.xpath("//input[contains(@id,'NewActivityDV-Mandatory_0')]");
	final By RA_UWA_Mandatory_No   = By.xpath("//input[contains(@id,'NewActivityDV-Mandatory_1')]");
	final By RA_UWA_Recurring_Yes  = By.xpath("//input[contains(@id,'NewActivityDV-Recurring_0')]");
	final By RA_UWA_Recurring_No   = By.xpath("//input[contains(@id,'NewActivityDV-Recurring_1')]");
	final By RA_UWA_AssignTo       = By.xpath("//select[contains(@name,'NewActivityDV-SelectFromList')]");
	/*
	 * New Note
	 */
	final By RA_UWA_NewNote = By.xpath("//div[contains(@class,'gw-boldLabel') and text()='New Note']");

	final By RA_UWA_NN_Topic         = By.xpath("//select[contains(@name,'ActivityDetailNoteDV-Topic')]");
	final By RA_UWA_NN_Subject       = By.xpath("//input[contains(@name,'ActivityDetailNoteDV-NoteSubject')]");
	final By RA_UWA_NN_RelatedTo     = By.xpath("//div[contains(@class,'gw-ToolbarButtonWidget')]//div[@class='gw-minimized-view']/following-sibling::div[text()='Cance']");
	final By RA_UWA_NN_SecurityLevel = By.xpath("//select[contains(@name,'ActivityDetailNoteDV-SecurityLevel')]");
	final By RA_UWA_NN_Text          = By.xpath("//textarea[contains(@name,'ActivityDetailNoteDV-Text')]");

	final By RA_UWA_Release = By.xpath("//div[contains(@class,'gw-ToolbarButtonWidget')]//div[@class='gw-minimized-view']/following-sibling::div[text()='Release']");

	/*
	 * Prior Policies Tab
	 */

	final By RA_Tab_PriorPolicies = By.xpath("//div[contains(@id,'RiskAnalysisCV-PriorPolicyCardTab')]//div[@class='gw-label' and text()='Prior Policies']");

	final By RA_PP_PriorPolicies = By.xpath("//div[contains(@class,'gw-LabelWidget')]/div[contains(@class,'gw-label') and text()='Prior Policies']");
	...
	final By RA_Tab_PriorLosses = By.xpath("//div[contains(@id,'RiskAnalysisCV-LossHistoryCardTab')]//div[@class='gw-label' and text()='Prior Losses']");

	final By RA_PL_PriorLosses = By.xpath("//div[contains(@class,'gw-LabelWidget')]/div[contains(@class,'gw-label') and text()='Prior Losses']");
