...
public static void BuildingsAndLocations() throws Throwable {
	...
	try {
		...
		GuidewireAutomate("Add Building Button", AddBuildingButton, "clickAndwait", "clickAndwait");
		GuidewireAutomate("Add Building", AddBuilding, "moveToElement", "moveToElement");
		GuidewireAutomate("New Building", NewBuilding, "clickAndwait", "clickAndwait");	
		Thread.sleep(2000);
...
public static void NewBuildingDetails() throws Throwable {
	...
	try {
		lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("NewBuilding",
				strTestCaseName);
...
public static void NewBuildingCoverages() throws Throwable {
	...
	try {
		...
		GuidewireAutomate("Coverages", CoveragesTab, "clickAndwait", "clickAndwait");
