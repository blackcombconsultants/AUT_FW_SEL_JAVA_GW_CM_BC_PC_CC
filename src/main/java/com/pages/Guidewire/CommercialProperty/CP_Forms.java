...
public class CP_Forms extends SeleniumWebDriver_Commands  {

	public CP_Forms(WebDriver driver, ExtentTest oExtentTest) {
	...
	public static void forms_validate(String testingType) throws Throwable {
		switch (testingType) {
			case "VERIFY" :
				...
				GuidewireAutomate_Validation("forms Validate", Forms_Validate, "equals", lhm_TestCase_Table_Data.get("Form1"));
				break;
			default :
				break;
		}
	...
	public static void description_validate(String testingType) throws Throwable {
		switch (testingType) {
			case "VERIFY" :
				GuidewireAutomate_Validation("Description Validate", Description_Validate, "equals", lhm_TestCase_Table_Data.get("Form1_Description"));
