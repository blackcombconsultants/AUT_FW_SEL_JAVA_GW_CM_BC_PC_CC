...
public class HO_Coverages extends SeleniumWebDriver_Commands {
	...
	private static By HO_Coverages_Screen_titlebar = By
			.xpath("//div[contains(@id,'HOPCoveragesScreen-ttlBar')]//div[1]//div");

	/*
	 * CoveragesTab
	 */
	private static By Coverages_CoveragesTab = By
			.xpath("//div[contains(@id,'HOPCoveragesScreen-HOPMainCoveragesTab')]");

	/***
	 * Section I
	 */

	private static By HO_CT_CoveragesSectionICoverages = By.xpath(
			"//div[contains(@class,'gw-TitleBarWidget')]//div[@class='gw-TitleBar--title' and @role='heading' and contains(text(),'Section I Coverages')]");

	// --->HO_Coverages_CheckBox xpath
	private static By HO_CT_CATAV_CoverageADwelling = By.xpath(
			"//div[@role='heading' and text()='Coverage A - Dwelling']/preceding-sibling::div//input[contains(@name,'CoverageInputSet-CovPatternInputGroup')]");
	private static By HO_CT_CATAV_CovALimit = By.xpath("//input[contains(@name,'HOPCovALimit')]");

	private static By HO_CT_CATAV_ValuationMethod = By.xpath(
			"//div[@class='gw-label' and text()='Valuation Method']/parent::div//select[contains(@name,'CoverageInputSet')]");
	private static By HO_CT_CATAV_Coinsurance = By.xpath(
			"//div[@class='gw-label' and text()='Coinsurance']/parent::div//select[contains(@name,'CoverageInputSet')]");

	private static By HOC_CT_CATAV_CoverageBOtherStructures = By.xpath(
			"//div[@role='heading' and text()='Coverage B - Other Structures']/preceding-sibling::div//input[contains(@name,'CoverageInputSet-CovPatternInputGroup')]");
	private static By HOC_CT_CATAV_CovBLimitPct = By.xpath(
			"//div[@class='gw-label' and text()='CovB Limit Pct']/parent::div//select[contains(@name,'CoverageInputSet')]");

	private static By HOC_CT_CATAV_CoverageCPersonalProperty = By.xpath(
			"//div[@role='heading' and text()='Coverage C - Personal Property']/preceding-sibling::div//input[contains(@name,'CoverageInputSet-CovPatternInputGroup')]");
	private static By HOC_CT_CATAV_SelfStorageUnits = By.xpath(
			"//div[@class='gw-label' and text()='Self Storage Units']/parent::div//select[contains(@name,'CoverageInputSet')]");
	private static By HOC_CT_CATAV_PropertyatOtherResidence = By.xpath(
			"//div[@class='gw-label' and text()='Property at Other Residence']/parent::div//select[contains(@name,'CoverageInputSet')]");

	private static By HOC_CT_CATAV_CoverageDLossofUse = By.xpath(
			"//div[@role='heading' and text()='Coverage D - Loss of Use']/preceding-sibling::div//input[contains(@name,'CoverageInputSet-CovPatternInputGroup')]");
	private static By HOC_CT_CATAV_CovDLimitPct = By.xpath(
			"//div[@class='gw-label' and text()='CovD Limit Pct']/parent::div//select[contains(@name,'CoverageInputSet')]");
	...
	private static By HOC_CT_CATAV_ProhibitedUseCivilAuthority = By.xpath(
			"//div[@class='gw-label' and text()='Prohibited Use - Civil Authority']/parent::div//select[contains(@name,'CoverageInputSet')]");

	private static By HOC_CT_CATAV_SectionIDeductibles = By.xpath(
			"//div[@role='heading' and text()='Section I Deductibles']/preceding-sibling::div//input[contains(@name,'CoverageInputSet-CovPatternInputGroup')]");
	private static By HOC_CT_CATAV_AllPerils = By.xpath(
			"//div[@class='gw-label' and text()='All Perils']/parent::div//select[contains(@name,'CoverageInputSet')]");
	/***
	 * Section II
	 */
	private static By HOC_CT_CoveragesSectionIICoverages = By.xpath(
			"//div[contains(@class,'gw-TitleBarWidget')]//div[@class='gw-TitleBar--title' and @role='heading' and contains(text(),'Section II Coverages')]");
	private static By HOC_CT_CATAV_CoveragePersonalLiability = By.xpath(
			"//div[@role='heading' and text()='Coverage E - Personal Liability']/preceding-sibling::div//input[contains(@name,'CoverageInputSet-CovPatternInputGroup')]");
	private static By HOC_CT_CATAV_CovELimit = By.xpath(
			"//div[@class='gw-label' and text()='CovE Limit Pct']/parent::div//select[contains(@name,'CoverageInputSet')]");
	private static By HOC_CT_CATAV_PersonalInjury = By.xpath("//input[contains(@id,'BooleanTermInput_0')]");

	private static By HOC_CT_CATAV_CoverageFMedicalPaymentsToOthers = By.xpath(
			"//div[@role='heading' and text()='Coverage F - Medical Payments To Others']/preceding-sibling::div//input[contains(@name,'CoverageInputSet-CovPatternInputGroup')]");
	private static By HOC_CT_CATAV_CovFLimitPct = By.xpath(
			"//div[@class='gw-label' and text()='CovF Limit Pct']/parent::div//select[contains(@name,'CoverageInputSet')]");
	...
	public static void SectionICoverage() throws Throwable {
		...
		try {
		lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("Coverages",
				strTestCaseName);
		...
		GuidewireAutomate_Validation("Section I Coverages", HO_CT_CoveragesSectionICoverages, "contains",
				"Section I Coverages");
		}catch (Exception e) {
	...
	public static void CoverageADwelling() throws Throwable {
		...
		GuidewireAutomate("Coinsurance", HO_CT_CATAV_Coinsurance, "selectByVisibleText",
				lhm_TestCase_Table_Data.get("Coinsurance"));
		}catch (Exception e) {
	...
	public static void CoverageFMedicalPaymentsToOthers() throws Throwable {
		...
		public static void additionalcoverages() throws Throwable {
			...
			try {
				...
				lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("Coverages", strTestCaseName);
