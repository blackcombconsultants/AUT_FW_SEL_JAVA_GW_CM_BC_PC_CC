...
public class HO_DwellingConstruction extends SeleniumWebDriver_Commands {
	...
	public static void DwellingConstructionDetails() throws Throwable {
		...
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("dwellingConstruction",
					strTestCaseName);

			GuidewireAutomate_Validation("Screen Header", DWC_Header, "equals", "Dwelling Construction");
			
			GuidewireAutomate("DWC YearBuilt", DWC_YearBuilt, "sendKeys",
					lhm_TestCase_Table_Data.get("DWC_YearBuilt"));
			GuidewireAutomate("DWC Garage", DWC_Garage, "sendKeys",
					lhm_TestCase_Table_Data.get("DWC_Garage"));
			GuidewireAutomate("DWC Foundation ", DWC_Foundation, "sendKeys",
					lhm_TestCase_Table_Data.get("DWC_Foundation"));
			GuidewireAutomate("DWC Roof", DWC_Roof,
					"sendKeys", lhm_TestCase_Table_Data.get("DWC_Roof"));
			GuidewireAutomate("DWC PrimaryHeating", DWC_PrimaryHeating, "sendKeys",
					lhm_TestCase_Table_Data.get("DWC_PrimaryHeating"));
			...
			GuidewireAutomate("DWC HeatingYear", DWC_HeatingYear,
					"sendKeys", lhm_TestCase_Table_Data.get("DWC_HeatingYear"));
			GuidewireAutomate("DWC RoofYear", DWC_RoofYear, "sendKeys",
					lhm_TestCase_Table_Data.get("DWC_RoofYear"));
