...
public class HO_PolicyReview extends SeleniumWebDriver_Commands {
	 ...
	 * SectionI
	 */
	private static By PR_SectionI = By.xpath(
			"//div[contains(@id,'SectionICoverageLV')]//div[@class='gw-VerbatimWidget--inner' and text()='Section I Coverages']");
	private static By PR_DwellingCoverageA = By.xpath(
			"//div[contains(@id,'Description')]//div[@class='gw-value-readonly-wrapper' and text()='Coverage A - Dwelling Coverage']");
	private static By PR_DwellingCoverageB = By.xpath(
			"//div[contains(@id,'Description')]//div[@class='gw-value-readonly-wrapper' and text()='Coverage B - Other Structures Coverage']");
	private static By PR_DwellingCoverageC = By.xpath(
			"//div[contains(@id,'Description')]//div[@class='gw-value-readonly-wrapper' and text()='Coverage C - Personal Property Coverage']");
	private static By PR_DwellingCoverageD = By.xpath(
			"//div[contains(@id,'Description')]//div[@class='gw-value-readonly-wrapper' and text()='Coverage D - Loss of Use Coverage']");
	private static By PR_DwellingCoverageI = By.xpath(
			"//div[contains(@id,'Description')]//div[@class='gw-value-readonly-wrapper' and text()='Section I Deductibles Coverage']");
	/*****
	 * SectionII
	 */
	private static By PR_SectionII = By.xpath(
			"//div[contains(@id,'SectionIICoverageLV')]//div[@class='gw-VerbatimWidget--inner' and text()='Section II Coverages']");
	private static By PR_DwellingCoverageE = By.xpath(
			"//div[contains(@id,'Description')]//div[@class='gw-value-readonly-wrapper' and text()='Coverage E - Personal Liability Coverage']");
	private static By PR_DwellingCoverageF = By.xpath(
			"//div[contains(@id,'Description')]//div[@class='gw-value-readonly-wrapper' and text()='Coverage F - Medical Payments To Others Coverage']");
	private static By PR_AdditionalCoverages = By.xpath(
			"//div[contains(@id,'AdditionalCoverageLV')]//div[@class='gw-VerbatimWidget--inner' and text()='Additional Coverages']");
	private static By PR_OptionalCoverages = By.xpath(
			"//div[contains(@id,'OptionalCoverageLV')]//div[@class='gw-VerbatimWidget--inner' and text()='Optional Coverages']");
	private static By PR_PolicyConditions = By.xpath(
			"//div[contains(@id,'ConditionSummaryLV')]//div[@class='gw-VerbatimWidget--inner' and text()='Policy Conditions']");
	private static By PR_Modifiers = By.xpath(
			"//div[contains(@id,'HOPModifierSummaryLV')]//div[@class='gw-VerbatimWidget--inner' and text()='Modifiers']");
	...
	public static void PR_SectionICoverages() throws Throwable {
		...
		try {
			...
			GuidewireAutomate_Validation("Coverage A Dwelling Coverage", PR_DwellingCoverageA, "equals",
					"Coverage A - Dwelling Coverage ");
			GuidewireAutomate_Validation("Coverage B Other Structures Coverage", PR_DwellingCoverageB, "equals",
					"Coverage B - Other Structures Coverage");
			GuidewireAutomate_Validation("Coverage C  Personal Property Coverage", PR_DwellingCoverageC, "equals",
					"Coverage C - Personal Property Coverage");
			GuidewireAutomate_Validation("Coverage D  Loss of Use Coverage", PR_DwellingCoverageD, "equals",
					"Coverage D - Loss of Use Coverage");
			GuidewireAutomate_Validation("Section I Deductibles Coverage", PR_DwellingCoverageI, "equals",
					"Section I Deductibles Coverage");
	...
	public static void PR_SectionIICoverages() throws Throwable {
		...
		try {
			...
			GuidewireAutomate_Validation("Coverage E - Personal Liability Coverage", PR_DwellingCoverageE, "equals",
					"Coverage E - Personal Liability Coverage");
			GuidewireAutomate_Validation("Coverage F - Medical Payments To Others Coverage", PR_DwellingCoverageF,
					"equals", "Coverage F - Medical Payments To Others Coverage");
	...
	public static void PR_additionalCoverage() throws Throwable {
		...
		try {
			...
			GuidewireAutomate_Validation("Additional Coverages", PR_AdditionalCoverages, "equals",
