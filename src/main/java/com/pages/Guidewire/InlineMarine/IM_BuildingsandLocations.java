...
public class IM_BuildingsandLocations extends SeleniumWebDriver_Commands {
	...
	private static By BuildingsandLocations_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Buildings and Locations']");

	// Add Building
	private static By Add = By
			.xpath(" //div[contains(@id,'Actions-ActionsMenuIcon')]/div[@class='gw-action--expand-button']");
	private static By AddBuilding = By
			.xpath(" //div[contains(@id,'Actions-AddBuilding')]//div[@class='gw-label' and text()='Add Building']");
	private static By AB_NewBuilding = By
			.xpath(" //div[contains(@id,'Actions-AddBuilding')]//div[@class='gw-label' and text()='New Building']");

	// New Building
	private static By NewBuilding_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='New Building']");
	...
	public static void AddNewBuilding() throws Throwable {
		try {
			...
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("buildingsandLocations",
					strTestCaseName);
			GuidewireAutomate_Validation("Screen Header", BuildingsandLocations_Header, "equals",
	...
	public static void NewBuilding_Details() throws Throwable {
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("buildingsandLocations",
					strTestCaseName);
			GuidewireAutomate_Validation("Screen Header", NewBuilding_Header, "equals",
					"New Building");
