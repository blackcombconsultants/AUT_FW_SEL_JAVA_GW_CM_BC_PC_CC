...
public class IM_AccountsReceivable extends SeleniumWebDriver_Commands {
	...
	private static By AccountsReceivable_Header = By.xpath(
			"//div[contains(@class,'gw-isScreenTitle')]//div[@class='gw-TitleBar--title' and @role='heading' and text()='Accounts Receivable']");
	...
	public static void PartLevelInformation() throws Throwable {
		try {
			lhm_TestCase_Table_Data = Selenium_Utils_DataBase.getData_MSExcel_WorkSheet_Fillo("accountsReceivable",
					strTestCaseName);
			GuidewireAutomate_Validation("Screen Header", AccountsReceivable_Header, "equals",
					"Accounts Receivable");
