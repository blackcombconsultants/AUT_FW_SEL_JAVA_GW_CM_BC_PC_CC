...
public static void Driver() throws Throwable {
	...
	try {
		...
		GuidewireAutomate("Add Driver", DriversAddDriver, "clickAndwait", "clickAndwait");
...
public static void DriverDetails() throws Throwable {
	...
	try {
		...
		GuidewireAutomate("Drivers Details Ok Button", DriverDetailsOkButton, "clickAndwait", "clickAndwait");
