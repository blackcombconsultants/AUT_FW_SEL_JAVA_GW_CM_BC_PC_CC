	...
	public static void quoteDetails() throws Throwable {
		try {
		  ...
		  // GuidewireAutomate_Validation("SubmissionNumber", QU_SubmissionNumber,"equals", strSubmissionNumber);
			// GuidewireAutomate_Validation("PolicyPeriod", QU_PolicyPeriod, "contains", lhm_TestCase_Table_Data.get("QU_PolicyPeriod"));GuidewireAutomate_Validation("PrimaryNamedInsured", QU_PrimaryNamedInsured, "equals", strAccountName);
