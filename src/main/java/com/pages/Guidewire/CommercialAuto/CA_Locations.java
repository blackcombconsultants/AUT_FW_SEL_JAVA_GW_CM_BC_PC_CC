...
public static void NewLocation() throws Throwable{
	try {
		...
		/*
		 * GuidewireAutomate_Validation("Screen Header", LocationInformation_Header,
		 * "equals", "Location Information"); GuidewireAutomate("Address1", LI_Address1,
		 * "clearANDsendKeys", lhm_TestCase_Table_Data.get("CA_Address1"));
		 * GuidewireAutomate("City", LI_City, "clearANDsendKeys",
		 * lhm_TestCase_Table_Data.get("CA_City")); GuidewireAutomate("State", LI_State,
		 * "selectByVisibleText", lhm_TestCase_Table_Data.get("CA_State"));
		 * GuidewireAutomate("ZIPCode", LI_ZIPCode, "clearANDsendKeys",
		 * lhm_TestCase_Table_Data.get("CA_ZIPCode"));
		 * GuidewireAutomate("TerritoryCodeforGeneralLiabilityLine",
		 * LI_TerritoryCodeforGeneralLiabilityLine, "clearANDsendKeys",
		 * lhm_TestCase_Table_Data.get("CA_TCGL"));
		 */
